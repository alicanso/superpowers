...
Start by understanding the current project context, then ask all independent questions at once to refine the idea. Only dependent questions (whose answers depend on previous answers) go to the next round. Maximum 3 rounds of questions. Once you understand what you're building, present the design and get user approval.
...
3. **Ask clarifying questions** — all independent questions at once in one message, understand purpose/constraints/success criteria
...
- For appropriately-scoped projects, ask all independent questions at once in a single message
- Prefer multiple choice questions when possible, but open-ended is fine too
- Only dependent questions (whose answers depend on previous answers) go to the next round
- Maximum 3 rounds of questions total. After round 3, make the best decisions and proceed.
...
- **All independent questions at once** - Ask everything you need in one message, only dependents in next round
